		...
		if (act.length>0) {
			...
			//try{
				...
				switch (posttype) {
					...
					case "youtubeid":
						setTimeout(function() {
							act.html('<div class="eg-ajax-video-container '+videoaspect+'"><iframe width="560" height="315" src="//www.youtube-nocookie.com/embed/'+postid+'?autoplay=1&vq=hd1080" frameborder="0" allowfullscreen referrerpolicy="strict-origin-when-cross-origin"></iframe></div>');
						    removeLoader(act);
							showHideAjaxContainer(act,true,opt.ajaxScrollToOnLoad,opt.ajaxScrollToOffset);
							ajaxCallBack(opt,a);
						},300);
	 ...
	 if (!simpleframe)
		 item.find('.esg-media-video').each(function() {
		   ...
		   if (prep.data('youtube')!=undefined && item.find('.esg-youtube-frame').length==0) {
		  	  ...
		  	  var ytframe = "https://www.youtube-nocookie.com/embed/"+prep.data('youtube')+"?version=3&enablejsapi=1&html5=1&controls=1&autohide=1&rel=0&showinfo=0";
			  media.append('<iframe class="esg-youtube-frame" wmode="Opaque" style="position:absolute;top:0px;left:0px;display:none" width="'+prep.attr("width")+'" height="'+prep.attr("height")+'" data-src="'+ytframe+'" src="about:blank" referrerpolicy="strict-origin-when-cross-origin"></iframe>');
		   }
	...
	for (var q=0;q<items.length;q++) {			
		...
		if (item.find('.esg-click-to-play-video').length==0) {
			...
			if (prep.data('youtube')!=undefined) {
				...
				var ytframe = "https://www.youtube-nocookie.com/embed/"+prep.data('youtube')+"?version=3&enablejsapi=1&html5=1&controls=1&autohide=1&rel=0&showinfo=0";
			  	media.append('<iframe class="esg-youtube-frame" wmode="Opaque" style="position:absolute;top:0px;left:0px;'+videovisible+'" width="'+prep.attr("width")+'" height="'+prep.attr("height")+'" '+viddatasrc+'="'+ytframe+'" '+vidsrc+'="about:blank" referrerpolicy="strict-origin-when-cross-origin"></iframe>');
			}
